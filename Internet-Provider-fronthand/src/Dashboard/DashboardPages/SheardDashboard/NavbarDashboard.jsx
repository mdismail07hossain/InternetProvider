...
const NavbarDashboard = () => {
  ...
  return (
    <div className="fixed d-block bg-white bg-opacity-75 w-[100%] dark:bg-gray-700 z-10 backdrop-blur-sm ">
      <div className="flex justify-between py-4 px-8 shadow-lg items-center">
        ...
        <div className="">
          <input
            type="text"
            placeholder="Search..."
            className="border outline-none px-3 py-2 w-72 rounded-lg "
          />
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center  border-b pb-2">
                      <h2 className="text-lg font-semibold text-black rounded-lg">
                        Theme Settings
                      </h2>
            ...
            <div className="dropdown dropdown-end">
              ...
              >
                <li className="font-semibold">
                  <a href="">
                    <FontAwesomeIcon icon={faCalendarDays} /> My Schedules
                  </a>
                </li>
                <li className="font-semibold">
                  <a href="">
                    <FontAwesomeIcon icon={faTicket} /> Pricing
                  </a>
                </li>
                <li className="font-semibold">
                  <a href="">
